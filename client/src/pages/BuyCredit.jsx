    ...
    <div className='min-h-[80vh] text-center pt-14 mb-10'>
      ...
      <div className='flex flex-warp justify-center gap-6 text-left'>
        {plans.map((item , index)=>(
          <div
          className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all duration-500 ' key={index}>
            <img width={40} src={assets.icon_logo} alt="" />
